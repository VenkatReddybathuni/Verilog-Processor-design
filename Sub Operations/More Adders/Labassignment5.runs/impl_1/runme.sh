...
HD_PWD='C:/Users/VENKAT/OneDrive/Documents/vivado_files/Labassignment4/Labassignment5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lookahead_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lookahead_adder.tcl -notrace
