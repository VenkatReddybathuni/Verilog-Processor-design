...
HD_PWD='C:/Users/VENKAT/OneDrive/Documents/vivado_files/Labassignment4/Labassignment5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lookahead_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lookahead_adder.tcl
